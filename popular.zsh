...
source "$_POPULAR_INSTALL_DIR/lib/popular/cmd-update.zsh"
source "$_POPULAR_INSTALL_DIR/lib/popular/cmd-cli.zsh"
source "$_POPULAR_INSTALL_DIR/lib/popular/cmd-help.zsh"
